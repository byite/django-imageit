...
class TestScaleItModelSmallSave(models.Model):
    def get_upload_path(instance, filename):
        return f'tests_media/imageit/{filename}'

    name = models.TextField(max_length=100, default='no_value')
    image = ScaleItImageField(max_width=1000, max_height=1000, max_save_size_mb=.001, quality=100, null=True, blank=True, upload_to=get_upload_path)
